<template>
  <div>
    <demoBlock title="基本使用">
      <uvCellGroup card>
        <uvCell title="primary 类型">
          <template #value>
            <uvTag>标签</uvTag>
          </template>
        </uvCell>
        <uvCell title="success 类型">
          <template #value>
            <uvTag type="success">
              标签
            </uvTag>
